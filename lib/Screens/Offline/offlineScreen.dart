...
import 'package:thesis/Screens/Offline/offlineShoppingListScreen.dart';
...
class _OfflineScreenState extends State<OfflineScreen>
  ...
  //Animated Offline Container
  Widget offlineContainer() {
    return TweenAnimationBuilder(
        tween: Tween<double>(
            begin: 0, end: MediaQuery.of(context).size.height * 0.035),
        duration: Duration(seconds: 1),
        builder: (_, double _val, __) {
          return Container(
